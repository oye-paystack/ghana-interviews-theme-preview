export const victorQuoteAudioSrc = `${import.meta.env.BASE_URL}audio/victor-quote-tight.m4a`;

export const victorQuoteSegments = [
  ...
  { start: 18.66, end: 20.42, text: "And so I'm like, you know what," },
  { start: 20.42, end: 24.7, text: "let me just use Paystack." },
];
