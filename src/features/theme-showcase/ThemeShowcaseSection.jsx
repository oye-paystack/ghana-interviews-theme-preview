...
const FIRST_THEME_FRAME_HOLD_DISTANCE = 200;
const FIRST_THEME_FRAME_EXIT_DISTANCE = 200;
const DETAIL_FRAME_REVEAL_DISTANCE = 100;
const DETAIL_FRAME_HOLD_DISTANCE = 200;
const DETAIL_FRAME_EXIT_DISTANCE = 100;
